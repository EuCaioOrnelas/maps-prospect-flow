...
serve(async (req) => {
  ...
  try {
    ...
    // Service role can validate any user token regardless of signing algorithm
    ...
    // Use service role client to validate token - works on ALL Supabase environments
    console.log('[debug-dispatch-test] Validating token with service role getUser...');
