...
const VALID_NODE_TYPES = ["entry", "message", "buttons", "condition", "wait", "action", "ai_agent", "handoff", "end", "data_collect", "random_split", "ab_test", "google_sheets", "google_calendar", "gmail"] as const;
