...
export const DEFAULT_RENEWAL_SETTINGS: Required<
  Pick<
    RenewalSettings,
...
export function buildFromAddress(s: RenewalSettings): string {
...
export function renderRenewalEmail(settings: RenewalSettings, data: RenewalEmailData): { subject: string; html: string } {
