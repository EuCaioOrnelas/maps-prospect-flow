...
BEGIN
  ...
  -- Only auto-reset for FREE users based on calendar month
  -- Paid users have their searches reset by the Stripe webhook when subscription renews
  ...
  -- Check if we're in a new month since last reset (only for free users)
