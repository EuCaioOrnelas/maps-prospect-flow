...
- [ ] Implementar criptografia AES-256-GCM centralizada para chat_messages e previews, migrar legado sem destruição e auditar todos os caminhos de leitura/gravação. Bloqueio: migração legada requer execução administrativa autenticada.
