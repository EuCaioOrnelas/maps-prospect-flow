...
const CRMInteligencia = lazyWithRetry(() => import("./pages/CRMInteligencia"), "CRMInteligencia");
...
const AdminTrials = lazyWithRetry(() => import("./pages/admin/AdminTrials"), "AdminTrials");
...
const AdminInfluencerOutreach = lazyWithRetry(() => import("./pages/admin/AdminInfluencerOutreach"), "AdminInfluencerOutreach");
          ...
          <AuthProvider>
            ...
            <Suspense fallback={<PageLoader />}>
              ...
              <Routes>
                ...
                <Route path="/tour-guiado" element={<DashboardThemeProvider><Suspense fallback={<PageLoader />}><TourGuiado /></Suspense></DashboardThemeProvider>} />
               ...
               <Route path="/acesso-negado" element={<ProtectedRoute><Suspense fallback={<PageLoader />}><AccessDenied /></Suspense></ProtectedRoute>} />
                ...
                {/* Meta Platforms */}
                <Route path="/forms" element={<ProtectedRoute><Suspense fallback={<PageLoader />}><Forms /></Suspense></ProtectedRoute>} />
                ...
                <Route path="/meta/guia-conexao" element={<MetaConnectGuide />} />
                ...
                >
                  ...
                  <Route path="partners/abordagem" element={<AdminInfluencerOutreach />} />
                </Route>
                ...
                >
                  ...
                  <Route path="ai-guide" element={<IntegrationAiGuide />} />
