...
export const rangeCalendarClassNames = {
  ...
  day_range_middle: "!rounded-none !bg-transparent hover:!bg-primary/25",
  day_range_start:
  ...
  day_selected: "bg-transparent text-foreground hover:bg-primary/25 hover:text-foreground focus:bg-primary/25",
