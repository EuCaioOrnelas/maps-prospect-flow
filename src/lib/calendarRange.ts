...
export const rangeCalendarClassNames = {
  ...
  day: cn(
    ...
    "hover:bg-primary/20 hover:text-foreground aria-selected:opacity-100",
  ),
  day_range_middle:
    "!rounded-none !bg-transparent !text-foreground hover:!bg-primary/25 hover:!text-foreground",
  day_range_start:
  ...
  day_outside: "day-outside text-muted-foreground/45 aria-selected:text-primary-foreground",
