...
// Ícone oficial WhatsApp (branco) usado nos botões de envio manual
const WhatsAppIcon = ({ size = 16 }: { size?: number }) => (
  <svg viewBox="0 0 32 32" width={size} height={size} fill="currentColor" aria-hidden="true">
    <path d="M19.11 17.205c-.372 0-1.088 1.39-1.518 1.39a.63.63 0 0 1-.315-.1c-.802-.402-1.504-.817-2.163-1.447-.545-.516-1.146-1.29-1.46-1.963a.426.426 0 0 1-.073-.215c0-.33.99-.945.99-1.49 0-.143-.73-2.09-.832-2.335-.143-.372-.214-.487-.6-.487-.187 0-.36-.043-.53-.043-.302 0-.53.115-.746.315-.688.645-1.032 1.318-1.06 2.264v.114c-.015.99.472 1.977 1.017 2.78 1.23 1.82 2.506 3.41 4.554 4.34.616.287 2.035.888 2.722.888.817 0 2.15-.515 2.478-1.318.184-.46.184-.86.126-1.318-.13-.20-.20-.20-.60-.34zM16.12 5.077A10.923 10.923 0 0 0 5.196 15.998c0 2.13.607 4.132 1.72 5.867L4.997 27l5.303-1.706a10.898 10.898 0 0 0 5.822 1.664h.004c6.02 0 10.936-4.897 10.936-10.917 0-2.913-1.14-5.65-3.204-7.71a10.907 10.907 0 0 0-7.737-3.254zm0 19.7c-1.71 0-3.375-.46-4.83-1.323l-.35-.203-3.593 1.156 1.174-3.483-.226-.36a9.084 9.084 0 0 1-1.395-4.847c.003-5.026 4.11-9.13 9.136-9.13 2.44 0 4.72.95 6.443 2.68a9.076 9.076 0 0 1 2.667 6.463c-.002 5.026-4.09 9.048-9.116 9.048z"/>
  </svg>
);
