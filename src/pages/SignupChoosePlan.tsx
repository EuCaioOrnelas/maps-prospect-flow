...
const PLANS = [
  {
    ...
    highlight: false,
    perks: [
      "Atendimento Operacional com IA (WhatsApp oficial)",
      "CRM Comercial com IA de Intenção de Compra",
      "Fluxos Inteligentes com Wiize AI",
      "Campanhas via Meta API + WhatsApp Cloud",
      "Cockpit Executivo e dashboards de operação",
      "Até 2 números WhatsApp conectados",
      "Suporte por email",
    ],
    limitations: [
      "Sem SDR IA (prospecção)",
      "Sem Diagnóstico Comercial com IA",
      "Sem Geração de mensagens por IA",
      "Sem IA Closer",
    ],
  },
  {
    ...
    perks: [
      ...
      "Geração de mensagens por IA contextual",
      "Follow-up Inteligente com cadência adaptativa",
      "IA Closer — Copiloto Comercial em conversas",
