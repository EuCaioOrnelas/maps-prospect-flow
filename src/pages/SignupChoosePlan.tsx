...
const PLANS = [
  {
    ...
    highlight: false,
    perks: [
      "Chat WhatsApp centralizado (todos os números)",
      "Campanhas Meta Ads + WhatsApp oficial",
      "Cockpit executivo e dashboards completos",
      "Fluxos e automações de atendimento",
      "CRM com Score de Intenção de Compra",
  ...
  },
  {
    ...
    monthly: 696,
    opportunities: "3.000",
    desc: "Tudo do Atendimento + SDR IA: captação, diagnóstico e mensagens por IA",
    highlight: true,
    perks: [
      "Tudo do plano Atendimento",
      "SDR IA — captação automática por nicho e região",
      "Diagnóstico de leads com IA (dores, porte, maturidade)",
      "Geração de mensagens personalizadas por contexto (IA)",
      "Follow-up automático inteligente",
      "IA Closer em conversas",
