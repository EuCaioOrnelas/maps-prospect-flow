...
import { Check, X, Sparkles, Crown, Loader2, Settings, AlertTriangle, Shield, Clock, CreditCard, Rocket, TrendingUp, Building2, Calculator, Calendar, Gift, LogOut, Headphones, Users, Bot, Target } from "lucide-react";
  ...
  monthly: [
    {
      ...
      features: [
        ...
        { text: "Até 1 número WhatsApp conectado" },
    ...
    },
    {
      ...
      features: [
        ...
        { text: "Até 1.000 oportunidades qualificadas / mês" },
        ...
        { text: "Até 1 número WhatsApp conectado" },
        { text: "Até 3 usuários da conta (multiusuário)" },
