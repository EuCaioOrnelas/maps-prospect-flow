  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-gradient-to-r from-primary/5 to-emerald-500/5 rounded-full blur-3xl" />
      </div>
      ...
      <main className="relative container mx-auto px-4 py-8 md:py-12">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 shadow-[0_0_20px_hsl(var(--primary)/0.2)]">
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-6 md:gap-8 items-start">
          ...
          >
            {contactInfo.map((info, index) => (
              <motion.div
                key={index}
                className="flex items-center gap-4 p-4 md:p-5 bg-card border border-border/50 rounded-xl hover:border-primary/30 hover:shadow-[0_0_20px_hsl(var(--primary)/0.1)] transition-all duration-300"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            {/* Quick Tip */}
            <motion.div
              className="p-4 md:p-5 bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 rounded-xl shadow-[0_0_30px_hsl(var(--primary)/0.15)]"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-semibold text-primary mb-1">Atendimento instantâneo</p>
