          ...
          <div className="pointer-events-none absolute inset-0 z-20 hidden lg:block">
            <div className="container mx-auto grid h-full w-full max-w-[90rem] grid-cols-[minmax(0,0.9fr)_minmax(0,1fr)] gap-12 lg:gap-12 px-6 sm:px-10 lg:px-16">
              ...
              <div className="h-full min-w-0">
                {/* O próprio visual é o sticky: sem altura mínima ele acompanha o scroll
                    do hero até o final de "Como funciona". */}
                <div className="sticky top-24 ml-auto mr-0 mt-40 w-full min-w-0" style={{ maxWidth: "clamp(19rem, 32vw, 30rem)" }}>
