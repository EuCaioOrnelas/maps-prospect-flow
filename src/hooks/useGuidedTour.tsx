...
export function GuidedTourProvider({ children }: { children: ReactNode }) {
  ...
  const steps: TourStep[] = [
    ...
    // ---- Cockpit ----
    {
      id: "cockpit-overview",
      route: "/dashboard",
      target: '[data-tour="cockpit-hero-focus"]',
    ...
    },
    {
      id: "cockpit-forecast",
      route: "/dashboard",
      target: '[data-tour="cockpit-forecast-focus"]',
    ...
    // ---- Gestão / Diagnóstico ----
    {
      ...
      title: "Item Gestão",
      body: "Toda empresa captada vai parar na Gestão de Oportunidades. É aqui que a IA analisa cada uma delas em profundidade. Vamos entrar.",
      placement: "right",
      sidebarSection: "oportunidades",
      waitMs: 700,
    },
    {
      ...
      body: "Cada empresa recebe uma pontuação, um diagnóstico de pontos fortes e fracos e uma probabilidade de fechamento, tudo gerado automaticamente.",
      placement: "center",
      injectDemoLead: true,
      waitMs: 700,
    },
