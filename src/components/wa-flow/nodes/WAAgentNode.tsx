  ...
  return (
    <div className="bg-card border border-border rounded-xl shadow-sm w-52">
      ...
      <div className="flex items-center gap-2.5 px-4 py-3 border-b border-border/50">
        <div className="w-8 h-8 rounded-lg bg-violet-500/10 flex items-center justify-center shrink-0 overflow-hidden">
          {providerIcon ? (
            <img src={providerIcon} alt={PROVIDER_LABELS[provider]} className="w-5 h-5 rounded-sm" />
          ) : (
