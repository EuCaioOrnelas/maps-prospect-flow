...
export const ProblemSection = () => {
 ...
 const cardBase =
 "group rounded-card border border-border/70 bg-card/95 transition-shadow duration-500 ease-out p-3 sm:p-3.5 h-full flex flex-col relative overflow-hidden hover:shadow-md";
 const cardGlowMain =
 ...
 <div className="w-9 h-9 rounded-sm bg-destructive/10 flex items-center justify-center mb-3">
 ...
 <div className="w-8 h-8 rounded-sm bg-destructive/10 flex items-center justify-center mb-2">
 ...
 <div className="flex-shrink-0 text-left sm:text-right pt-3 sm:pt-0 sm:pl-6 border-t sm:border-t-0 sm:border-l border-border/50 relative z-10 w-full sm:w-auto">
                ...
                <p className="text-[11px] text-muted-foreground mt-1 max-w-[190px] sm:ml-auto">do esforço vira reunião real</p>
 </div>
 </div>
 }
 />
