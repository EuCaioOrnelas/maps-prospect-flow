                ...
                return safeFunnel.map((s) => {
                  ...
                  return (
                    <div key={s.stage} className="w-full flex flex-col items-center">
                      ...
                      <div
                        className={`h-8 rounded-full bg-gradient-to-r from-primary to-primary/80 inline-flex items-center justify-center gap-1.5 transition-all ring-1 ring-primary/20 shadow-[0_1px_2px_rgba(0,0,0,0.06)] whitespace-nowrap ${padClass}`}
