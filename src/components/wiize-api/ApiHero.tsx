...
export const ApiHero = () => {
  return (
    <section className="relative -mt-[72px] w-full overflow-x-clip pb-36 pt-[112px] sm:-mt-[80px] sm:pb-44 sm:pt-[128px] lg:pb-56">
      ...
      <div
        className="pointer-events-none absolute bottom-[-2.5rem] left-1/2 z-[5] h-40 w-[112vw] origin-center -translate-x-1/2 -rotate-[4deg] overflow-hidden sm:bottom-[-3.5rem] sm:h-48 lg:bottom-[-5rem] lg:h-56"
        aria-hidden
      >
          ...
          <div className="text-center xl:text-left">
            ...
            >
              <Link to="/api/login?modo=cadastro" className="shrink-0">
                <Button variant="hero" size="lg" className="group h-11 rounded-full px-6 text-sm sm:h-12 sm:px-8 sm:text-base">
                  Criar conta grátis
                  <ArrowRight size={14} className="ml-1.5 transition-transform group-hover:translate-x-0.5 sm:ml-2" />
                </Button>
              </Link>
