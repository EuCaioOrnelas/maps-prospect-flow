...
import { MessageSquare, Shield, Smartphone, ArrowRight, X } from "lucide-react";
...
export const ChatOfficialApiDialog = ({ open, onClose, hasConnection }: ChatOfficialApiDialogProps) => {
  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="sm:max-w-[480px] p-0 overflow-hidden border-border/50 gap-0">
        {/* Header */}
        <div className="relative bg-gradient-to-br from-primary/10 via-primary/5 to-transparent px-8 pt-8 pb-6">
          ...
          <h2 className="text-xl font-semibold text-foreground">
            Chat exclusivo para API Oficial
          </h2>
          <p className="text-sm text-muted-foreground mt-1.5 leading-relaxed">
            O chat da Wiize funciona apenas com números conectados via API Oficial da Meta.
          </p>
        </div>
        ...
        <div className="px-8 py-6 space-y-4">
          ...
          <div className="space-y-3">
            <div className="flex gap-3 items-start p-3.5 rounded-xl bg-muted/50 border border-border/30">
              ...
              <div>
                <p className="text-sm font-medium text-foreground">Por que preciso da API Oficial?</p>
                <p className="text-xs text-muted-foreground mt-0.5 leading-relaxed">
                  Ao conectar um número via API Oficial, o WhatsApp no celular deixa de receber mensagens. 
            ...
            <div className="flex gap-3 items-start p-3.5 rounded-xl bg-muted/50 border border-border/30">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground mt-0.5 leading-relaxed">
                  Todas as mensagens passam pela infraestrutura oficial da Meta, garantindo 
                  conformidade, criptografia e rastreamento de entrega em tempo real.
                </p>
              </div>
            </div>
          </div>
