                  ...
                  <div className="flex items-start justify-between gap-2 mb-[1px]">
                    ...
                    <div className="shrink-0 w-[104px] flex items-center justify-end gap-1.5">
                        ...
                        >
                          ...
                          <DropdownMenuItem
                            onClick={(e) => { e.stopPropagation(); setOpenMenuId(null); onTogglePin(conv.id); }}
                            className="wa-dropdown-item flex items-center gap-2.5 px-3 py-2 mx-1 my-0.5 rounded-lg text-[13px] cursor-pointer"
                          >
                            <Pin size={14} />
                          ...
                          <DropdownMenuItem
                            onClick={(e) => { e.stopPropagation(); setOpenMenuId(null); onToggleMute(conv.id); }}
                            className="wa-dropdown-item flex items-center gap-2.5 px-3 py-2 mx-1 my-0.5 rounded-lg text-[13px] cursor-pointer"
                          >
                            <VolumeX size={14} />
                          ...
                          <DropdownMenuItem
                            onClick={(e) => { e.stopPropagation(); setOpenMenuId(null); onArchive(conv.id); }}
                            className="wa-dropdown-item flex items-center gap-2.5 px-3 py-2 mx-1 my-0.5 rounded-lg text-[13px] cursor-pointer"
                          >
