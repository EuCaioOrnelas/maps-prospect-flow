...
export function WhatsAppAudio({ src, isOutbound, avatarUrl, avatarInitials = "", avatarColorClass = "bg-muted" }: Props) {
  ...
  return (
    <div className="flex items-center gap-2 px-1 py-1 min-w-[260px] max-w-[330px]">
