        ...
        <Tabs defaultValue="info" className="flex min-h-0 flex-1 flex-col overflow-hidden">
          <div className="shrink-0 overflow-x-auto wa-scrollbar px-3 py-3 sm:px-6">
            <TabsList className="inline-flex min-w-max max-w-none gap-1">
              <TabsTrigger value="info" className="shrink-0 whitespace-nowrap px-2.5 text-[11px] sm:px-3 sm:text-sm">Perfil</TabsTrigger>
              <TabsTrigger value="availability" className="shrink-0 whitespace-nowrap px-2.5 text-[11px] sm:px-3 sm:text-sm">Disponibilidade</TabsTrigger>
              <TabsTrigger value="time" className="shrink-0 whitespace-nowrap px-2.5 text-[11px] sm:px-3 sm:text-sm">Tempo de uso</TabsTrigger>
              <TabsTrigger value="ops" className="shrink-0 whitespace-nowrap px-2.5 text-[11px] sm:px-3 sm:text-sm">Operacional</TabsTrigger>
            </TabsList>
          </div>

          <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden px-3 pb-3 sm:px-6 sm:pb-6">
          <TabsContent value="info" className="mt-0 min-w-0 space-y-3">
          ...
          <TabsContent value="availability" className="mt-0 min-w-0 space-y-4">
            <MemberAvailabilityCard userId={member.user_id} title={`Disponibilidade de ${member.name || member.email}`} />
          </TabsContent>

          <TabsContent value="time" className="mt-0 min-w-0 space-y-4">
          ...
          <TabsContent value="ops" className="mt-0 min-w-0 space-y-4">
            <div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
              <RangePicker value={range} onChange={setRange} from={customFrom} to={customTo} onFromChange={setCustomFrom} onToChange={setCustomTo} />
              <Button
                size="sm"
