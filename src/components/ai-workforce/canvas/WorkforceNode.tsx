  ...
  if (isCore) {
    return (
      <div className="relative" style={{ width: 220, height: 220 }}>
        ...
        {/* Centered invisible target handle covering whole circle */}
        <Handle
          type="target"
  ...
  return (
    ...
    >
      <Handle
        type="source"
        position={Position.Right}
        className="!h-2.5 !w-2.5 !bg-primary/60 !border-2 !border-background"
      />
      <Handle
        type="target"
        position={Position.Left}
        className="!h-2.5 !w-2.5 !bg-muted-foreground/40 !border-2 !border-background"
      />
