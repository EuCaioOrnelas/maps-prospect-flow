...
const STEPS = [
  ...
  },
  {
    title: "Estratégia",
    icon: Brain,
    headline: "Qual a estratégia de condução?",
  ...
  useEffect(() => {
    ...
    if (editing) {
      setDraft({
        ...SDR_DEFAULT_DRAFT,
        name: editing.name ?? "",
        objective: normalizeSdrObjective(editing.objective),
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const payload: any = {
        ...
        objective: normalizeSdrObjective(draft.objective),
