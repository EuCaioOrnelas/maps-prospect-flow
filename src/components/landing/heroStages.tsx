...
import {
  Search, Zap, TrendingUp, MessageCircle, Users, Send, Check,
  Bot, Star, CalendarCheck, LayoutGrid, Sparkles, Clock,
...
/* ─── Stage renders ─── */
export const StageCapture = ({ progress }: { progress: number }) => {
 const leads = [
...
export const StageDiagnosis = ({ progress }: { progress: number }) => {
...
export const StageMessage = ({ progress }: { progress: number }) => {
...
export const StageSend = ({ progress }: { progress: number }) => {
 const contacts = [
 "CrossFit Box SP",
 "Arena Fit Training",
 "Power Gym Plus",
...
export const StageReply = ({ progress }: { progress: number }) => {
 const messages = [
 {
 dir: 'out',
...
export const StageAIChat = ({ progress }: { progress: number }) => {
 const msgs = [
...
export const StageClose = ({ progress }: { progress: number }) => {
...
export const StageCRM = ({ progress }: { progress: number }) => {
...
export const stageRenderers = [StageCapture, StageDiagnosis, StageMessage, StageSend, StageAIChat, StageClose, StageCRM];
