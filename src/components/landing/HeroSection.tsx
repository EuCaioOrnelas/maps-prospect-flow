...
const floatingCards = [
  { 
    ...
    position: "-left-4 xl:-left-28 2xl:-left-36 top-4 lg:top-2",
    delay: "0.8s"
  },
  { 
    icon: Users, 
    ...
    position: "-right-4 xl:-right-28 2xl:-right-36 -top-4 lg:-top-8",
    delay: "1.2s"
  },
  { 
    icon: TrendingUp, 
    ...
    position: "-left-6 xl:-left-32 2xl:-left-40 bottom-[100px] lg:bottom-[90px]",
    delay: "1.6s"
  },
  { 
    icon: Zap, 
    ...
    position: "-right-4 xl:-right-24 2xl:-right-32 bottom-2 lg:bottom-0",
    delay: "2s"
  },
];
...
export const HeroSection = ({ onSignupClick }: HeroSectionProps) => {
  ...
  return (
    <section 
      ref={sectionRef}
      className="relative min-h-[85vh] flex items-center justify-center pt-16 pb-10 overflow-hidden w-full"
    >
      ...
      <div className="container mx-auto px-6 sm:px-10 lg:px-16 relative z-10 max-w-[90rem] w-full">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-4 lg:gap-6 items-center">
