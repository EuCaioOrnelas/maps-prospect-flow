        ...
        <div className="grid grid-cols-1 xl:grid-cols-[1.3fr_1fr] gap-2 xl:gap-4 items-center">
          ...
          <div className="text-center xl:text-left">
            ...
            <h1 className="font-display font-bold mb-4 sm:mb-6 animate-slide-up text-foreground leading-[1.08] tracking-tight" style={{ animationDelay: "0.1s" }}>
              <span className="block whitespace-nowrap text-[2.15rem] sm:text-[2.6rem] md:text-[3.2rem] lg:text-[3.6rem] xl:text-[4rem]">IA comercial que</span>
              <span className="block whitespace-nowrap text-[2.15rem] sm:text-[2.6rem] md:text-[3.2rem] lg:text-[3.6rem] xl:text-[4rem]">transforma leads em</span>
              <span className="block whitespace-nowrap text-shimmer-highlight text-[2.6rem] sm:text-[3.1rem] md:text-[3.8rem] lg:text-[4.3rem] xl:text-[4.8rem] leading-[1.05] mt-1 sm:mt-2">oportunidades reais</span>
            </h1>
