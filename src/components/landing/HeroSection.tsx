    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10 max-w-6xl w-full">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="glass rounded-xl px-3 sm:px-6 py-3 sm:py-4 mb-8 sm:mb-10 max-w-2xl mx-auto animate-slide-up" style={{ animationDelay: "0.25s" }}>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 md:gap-6 text-xs sm:text-sm">
              <div className="flex items-center gap-1.5 sm:gap-2">
                <Target size={14} className="text-primary flex-shrink-0 sm:w-4 sm:h-4" />
                <span className="whitespace-nowrap">Leads pré-qualificados</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                <MessageCircle size={14} className="text-primary flex-shrink-0 sm:w-4 sm:h-4" />
                <span className="whitespace-nowrap">Disparo via WhatsApp</span>
              </div>
              <div className="flex items-center gap-1.5 sm:gap-2">
                <TrendingUp size={14} className="text-primary flex-shrink-0 sm:w-4 sm:h-4" />
                <span className="whitespace-nowrap">Maior conversão</span>
              </div>
            </div>
          </div>
