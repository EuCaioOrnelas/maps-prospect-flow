...
export const ImpactNumbersSection = () => {
  ...
  return (
    ...
    >
      {/* Background Paths */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden opacity-[0.35]" style={{ transform: 'rotate(-12deg) translate(-200px, 60px)', transformOrigin: 'top left' }}>
