...
const testimonials: Testimonial[] = [
  {
    text: "O Wiize revolucionou nossa prospecção. Em uma semana conseguimos 3x mais leads qualificados do que em um mês usando métodos tradicionais.",
  ...
  {
    text: "O ROI foi imediato. No primeiro mês já fechamos 5 novos clientes que vieram das buscas do Wiize.",
