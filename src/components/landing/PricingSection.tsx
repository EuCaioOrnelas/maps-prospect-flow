  ...
  monthly: [
    {
      ...
      features: [
        { text: "Chat WhatsApp centralizado (todos os números)" },
        { text: "Campanhas Meta Ads + WhatsApp oficial" },
        { text: "Cockpit executivo e dashboards completos" },
        { text: "Fluxos e automações de atendimento" },
        { text: "CRM com Score de Intenção de Compra" },
    ...
    },
    {
      ...
      anchorPrice: "1.392",
      opportunities: "3.000",
      description: "Tudo do Atendimento + SDR IA: captação, diagnóstico e mensagens por IA.",
      features: [
        { text: "Tudo do plano Atendimento", highlight: true },
        { text: "SDR IA — captação automática por nicho e região", highlight: true },
        { text: "Diagnóstico de leads com IA (dores, porte, maturidade)", highlight: true },
        { text: "Geração de mensagens personalizadas por contexto (IA)", highlight: true },
  ...
  const comparisonGroups: Array<{
  ...
  }> = [
    {
      ...
      rows: [
        ...
        { label: "Mensagens personalizadas geradas por IA", start: true, growth: true, scale: true },
        { label: "Enriquecimento automático (site, contatos, redes sociais)", start: true, growth: true, scale: true },
        { label: "Segmentação por nicho, região e porte da empresa", start: true, growth: true, scale: true },
    ...
    },
    {
      ...
      rows: [
        ...
        { label: "Atendimento 24/7 sem precisar de plantão humano", start: false, growth: true, scale: true },
        { label: "Respostas automáticas com contexto do lead", start: false, growth: true, scale: true },
        { label: "Handoff inteligente — IA passa para humano na hora certa", start: false, growth: true, scale: true },
        { label: "Múltiplos atendentes no mesmo número", start: false, growth: true, scale: true },
