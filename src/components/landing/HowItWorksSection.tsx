...
const steps = [
  ...
  },
  {
    ...
    description: "Conecte seu WhatsApp em segundos via QR Code. Dispare mensagens personalizadas em massa com intervalos inteligentes.",
    color: "from-primary to-emerald-500",
    bgColor: "bg-primary/10",
    glowColor: "shadow-primary/20",
  },
  {
    ...
    title: "Converta",
    subtitle: "Com Agente de IA",
    description: "Nosso agente de IA responde, qualifica e organiza seus leads no CRM automaticamente, 24 horas por dia.",
    color: "from-primary to-emerald-500",
    bgColor: "bg-primary/10",
    glowColor: "shadow-primary/20",
  },
