...
export const ProductHero = ({ product, sharedDesktopVisual = false }: ProductHeroProps) => {
  return (
    <section className="relative -mt-[72px] w-full overflow-x-clip pb-44 pt-[120px] sm:-mt-[80px] sm:pb-48 sm:pt-[136px] lg:pb-52">
      ...
      <div
        className="pointer-events-none absolute bottom-44 left-1/2 z-[5] h-24 w-[220vw] -translate-x-1/2 -rotate-[1deg] overflow-hidden sm:bottom-48 sm:h-32"
        aria-hidden
      >
