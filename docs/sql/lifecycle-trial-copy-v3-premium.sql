-- ============================================================
-- Wiize — Trial Email Flow | Copy V3 Premium
...
WITH new_copy (key, name, subject, preheader, content) AS (
  ...
  (
    ...
    $email$
      ...
      <p>Faça uma busca por nicho e localização. Em poucos minutos, você terá contexto para decidir onde vale investir atenção.</p>
  ...
  (
    ...
    $email$
      ...
      <p>Uma lista grande não garante um funil forte. <strong>Contexto é o que transforma nomes em oportunidades.</strong></p>
  ...
  (
    ...
    $email$
      ...
      <p>Você já sabe quem abordar. Agora, use o contexto encontrado para criar uma mensagem que tenha motivo para existir.</p>
      ...
      <p>Escolha uma oportunidade, revise o diagnóstico e inicie uma conversa clara pelo WhatsApp.</p>
  ...
  (
    ...
    $email$
      ...
      <p>Quando o cliente demonstra interesse, cada minuto importa. Sua equipe não precisa estar disponível o tempo inteiro para manter a conversa viva.</p>
      ...
      <p>Defina o que sua empresa oferece, como se comunica e quando o atendimento deve passar para uma pessoa.</p>
  ...
  (
    ...
    $email$
      ...
      <p>Defina quem entra no fluxo, quando a próxima ação acontece e qual mensagem preserva o contexto da conversa.</p>
  ...
  (
    ...
    $email$
      ...
      <blockquote>Você não precisa testar tudo. Precisa provar o fluxo que mais importa para sua operação.</blockquote>
  ...
  (
    ...
    $email$
      ...
      <p>Você conheceu uma forma de unir prospecção, conversas, CRM, IA e automação em uma operação mais clara.</p>
      ...
      <p>Se a Wiize faz sentido para sua empresa, escolha o plano que mantém seu trabalho e sua rotina em movimento.</p>
  ...
  (
    ...
    $email$
      ...
      <p>Seu teste terminou, mas o que você configurou permanece vinculado à sua conta.</p>
